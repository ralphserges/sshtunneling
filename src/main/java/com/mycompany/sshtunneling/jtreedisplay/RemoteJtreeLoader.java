 ...
 * @author LIU ZI AN
 */
public class RemoteJtreeLoader implements TreeWillExpandListener {
    
    public RemoteJtreeLoader() {
        
    }

    @Override
    public void treeWillExpand(TreeExpansionEvent path) throws ExpandVetoException {
        ChannelSftp sftpChannel = SSHClientGui.sftpChannel;
        ...
        try {
            loader.addNodesRemoteV2(selectedPath, selectedFileName, sftpChannel);
